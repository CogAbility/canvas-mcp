import { z } from "zod";
export function registerSectionTools(server, canvas) {
    // Tool: list-sections
    server.tool("list-sections", "Get a list of all sections in a course", {
        ...
        try {
            while (hasMore) {
                ...
                const pageSections = await canvas.listSections(courseId, params);
