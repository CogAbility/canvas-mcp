export class DataAnonymizer {
     ...
     */
    static anonymizeSubmission(submission) {
        if (!submission)
            return submission;
        ...
        if (submission.submission_comments && Array.isArray(submission.submission_comments)) {
            anonymized.submission_comments = submission.submission_comments.map((comment) => {
     ...
     */
    static anonymizeSubmissions(submissions) {
     ...
     */
    static anonymizeAssignment(assignment) {
        if (!assignment)
            return assignment;
     ...
     */
    static anonymizeAssignments(assignments) {
